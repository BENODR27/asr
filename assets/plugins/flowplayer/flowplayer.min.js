        ...
        20: [function(t, n, r) {
            ! function(t, r, o) {
                ...
                var n, r = window,
                    ...
                    A = function(e, t) {
                        var r = function(t, r) {
                                for (var o, i = m(e) ? n(e, r) : e; t && t !== r; t = t.parentNode)
                                    for (o = i.length; o--;)
                                        if (i[o] === t) return t
                            },
                            o = function(e) {
                    ...
                    D = function(e, t, n) {
                        ...
                        if (o = u && t.replace(a, ""), o && x[o] && (o = x[o].base), !t || u)(l = u && t.replace(i, "")) && (l = h(l, ".")), P(e, o, n, l);
                    ...
                    F = function(e, t, n) {
                        var r, o, l, s, u, c = h(t);
                        for (r = c.length; r--;)
                            if (t = c[r].replace(a, ""), (s = c[r].replace(i, "")) && (s = h(s, ".")), s || n || !e[d])
                ...
                I(r, {
                    keys: function(t) {
                        ...
                        var l = [],
                            s = be && n;
                        if (i && we || r)
                            for (var u = 0; u < t.length; ++u) Y(l, a(u));
                        if (!r)
                            for (var c in t) s && "prototype" === c || !$(t, c) || Y(l, a(c));
                        if (ye)
                ...
                var qe = u.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
                    ...
                    Xe = function(e) {
                        ...
                        if (r = "", 0 > n && (r = "-", n = -n), o = "0", n > 1e-21)
                            if (i = ze.log(n * ze.pow(2, 69, 1)) - 69, l = 0 > i ? n * ze.pow(2, -i, 1) : n / ze.pow(2, i, 1), l *= 4503599627370496, i = 52 - i, i > 0) {
